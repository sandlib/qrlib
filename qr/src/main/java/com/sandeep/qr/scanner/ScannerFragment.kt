...
import com.sandeep.qr.R
import com.sandeep.qr.common.CustomViewFinderView
import com.sandeep.qr.core.IViewFinder
import com.sandeep.qr.core.ZXingScannerView
import com.sandeep.qr.databinding.ScannerFragmentBinding
...
class ScannerFragment constructor(private val listener: OnScannerListener) : Fragment() {
    ...
    private val zinxListener = ZXingScannerView.ResultHandler {result -> run {
        val sound = MediaPlayer.create(this@ScannerFragment.context!!, R.raw.snap)
